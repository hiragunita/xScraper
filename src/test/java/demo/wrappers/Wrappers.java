...
public class Wrappers {
        ...
        try{
            ...
            for(int i = 0; i < 4; i++){
                ...
                if(i < 4){
                    ...
                    Thread.sleep(2000); // Wait for the results
                }
            }
    ...
    public static void verifyFile(String string){
        String filePath = "src/test/resources/oscar-winner-data.json";
    ...
    //     throw new UnsupportedOperationException("Unimplemented method 'verifyFile'");
    // }
}
